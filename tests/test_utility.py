...
class TestNoneToNan(unittest.TestCase):
    ...
    def test_none_to_nan_long(self):
        result = none_to_nan(
            [np.arange(1, 100), np.arange(1, 100), None, np.arange(1, 100).tolist()]
        )
    ...
    def test_none_to_nan_nested_array_single(self):
        values_irregular = np.array(
            [
                None,
                np.array([np.array(1), np.array(2), np.array(3)]),
                None,
                np.array([np.array(1), np.array(2), np.array(3)]),
            ]
        )
        ...
        self.assertTrue(
            np.array_equal(
                result[1], np.array([np.array(1), np.array(2), np.array(3)])
            )
        )
        self.assertEqual(len(result[3]), 3)
        self.assertTrue(
            np.array_equal(
                result[3], np.array([np.array(1), np.array(2), np.array(3)])
            )
        )
    ...
    def test_none_to_nan_nested_array_single_no_none(self):
        ...
        self.assertTrue(
            np.array_equal(result, np.array([np.array(1), np.array(2), np.array(3)]))
        )
