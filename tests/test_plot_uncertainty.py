...
class TestPlotUncertainpy(TestCasePlot):
    def setUp(self):
        ...
        self.plot = PlotUncertainty(
            folder=self.output_test_dir,
            logger_level="error",
    ...
    def test_sensitivity_1_average(self):
        ...
        self.plot.average_sensitivity(
            feature="feature1d_var", sensitivity="sobol_first", hardcopy=True
        )
    ...
    def test_sobol_total_average(self):
        ...
        self.plot.average_sensitivity(
            feature="feature1d_var", sensitivity="sobol_total", hardcopy=True
        )
    ...
    def test_evaluations_1d(self):
        ...
        self.plot.data["TestingModel1d"].time = np.load(
            os.path.join(self.folder, "data/t_test.npy")
        )
        values = np.load(os.path.join(self.folder, "data/U_test.npy"))
        self.plot.data["TestingModel1d"].evaluations = [
            values,
            values,
            values,
            values,
        ...
        for plot in glob.glob(
            os.path.join(self.output_test_dir, "TestingModel1d_evaluations/*.png")
        ):
            plot_count += 1
    ...
    def test_evaluations_2d_feature(self):
        ...
        plot_count = 0
        for plot in glob.glob(
            os.path.join(self.output_test_dir, "feature2d_var_evaluations/*.png")
        ):
            plot_count += 1
    ...
    def test_evaluations_0d_feature(self):
        ...
        plot_count = 0
        for plot in glob.glob(
            os.path.join(self.output_test_dir, "feature0d_var_evaluations/*.png")
        ):
            plot_count += 1
    ...
    def test_evaluations_1d_feature(self):
        ...
        plot_count = 0
        for plot in glob.glob(
            os.path.join(self.output_test_dir, "feature1d_var_evaluations/*.png")
        ):
            plot_count += 1
    ...
    def test_evaluations_2d_model(self):
        ...
        plot_count = 0
        for plot in glob.glob(
            os.path.join(self.output_test_dir, "TestingModel2d_evaluations/*.png")
        ):
            plot_count += 1
    ...
    def test_evaluations_0d_model(self):
        ...
        compare_file = os.path.join(
            folder, "figures", "evaluations", "evaluations" + self.figureformat
        )

        plot_file = os.path.join(
            self.output_test_dir,
            "TestingModel0d_evaluations",
            "evaluations" + self.figureformat,
        )
    ...
    def test_init(self):
        plot = PlotUncertainty(folder=self.output_test_dir, logger_level="error")
    ...
    def assert_data(self):
        for data_type in self.data_types:
            self.assertTrue(
                np.array_equal(self.plot.data["feature1d"][data_type], [1.0, 2.0])
            )
            self.assertTrue(
                np.array_equal(
                    self.plot.data["TestingModel1d"][data_type], [3.0, 4.0]
                )
            )
        ...
        self.assertTrue(
            np.array_equal(
                self.plot.data["TestingModel1d"]["labels"], ["xlabel", "ylabel"]
            )
        )
        self.assertTrue(
            np.array_equal(
                self.plot.data["feature1d"]["labels"], ["xlabel", "ylabel"]
            )
        )
    ...
    def test_attribute_feature_1d_mean(self):
        ...
        self.plot.attribute_feature_1d(
            feature="TestingModel1d", attribute="mean", attribute_name="mean"
        )
    ...
    def test_attribute_feature_1d_variance(self):
        ...
        self.plot.attribute_feature_1d(
            feature="TestingModel1d", attribute="variance", attribute_name="variance"
        )
    ...
    def test_attribute_feature_2d_mean(self):
        ...
        self.plot.attribute_feature_2d(
            feature="feature2d_var", attribute="mean", attribute_name="mean"
        )
    ...
    def test_attribute_feature_2d_variance(self):
        ...
        self.plot.attribute_feature_2d(
            feature="feature2d_var", attribute="variance", attribute_name="variance"
        )
    ...
    def test_sensitivity_1_combined_model_result(self):
        ...
        self.plot.sensitivity_1d_combined(
            feature="TestingModel1d", sensitivity="sobol_first"
        )
    ...
    def test_sobol_total_combined_model_result(self):
        ...
        self.plot.sensitivity_1d_combined(
            feature="TestingModel1d", sensitivity="sobol_total"
        )
    ...
    def test_sensitivity_1_combined_feature1d_var(self):
        ...
        self.plot.sensitivity_1d_combined(
            feature="feature1d_var", sensitivity="sobol_first"
        )
    ...
    def test_sobol_total_combined_feature1d_var(self):
        ...
        self.plot.sensitivity_1d_combined(
            feature="feature1d_var", sensitivity="sobol_total"
        )
