...
class TestModel(unittest.TestCase):
    ...
    def test_postprocess_argument(self):
        ...
        model = Model(
            run=model_function, postprocess=postprocess, logger_level="error"
        )
...
class TestTestingModel2d(unittest.TestCase):
    def test_run(self):
        ...
        self.assertTrue(
            np.array_equal(
                values, np.array([np.arange(0, 10) - 1, np.arange(0, 10) - 2])
            )
        )
...
class TestNeuronModel(unittest.TestCase):
    ...
    def test_run(self):
        ...
        model = NeuronModel(
            file=file, path=os.path.join(filedir, path), logger_level="error"
        )
    ...
    def test_assign_run(self):
        ...
        model = NeuronModel(run=test_run, logger_level="error")
    ...
    def test_parallel(self):
        ...
        model = NeuronModel(path=path, interpolate=True, logger_level="error")
    ...
    def test_run_neuron_model(self):
        ...
        model = NeuronModel(
            path=path, interpolate=True, logger_level="error", stimulus_start=100
        )
    ...
    def test_load_python(self):
        ...
        model = NeuronModel(path=path, logger_level="error")
    ...
    def test_runmodel(self):
        ...
        self.assertEqual(
            len(result["NeuronModel"].evaluations[0]),
...
class TestNestModel(unittest.TestCase):
    def test_init(self):
        model = NestModel(brunel_network, logger_level="error")
    ...
    def test_evaluate(self):
        ...
        model = NestModel(run=f, b="test value")
