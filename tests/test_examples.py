...
class TestExamples(unittest.TestCase):
    def setUp(self):
        ...
        self.example_folder = os.path.join(os.path.dirname(self.folder), "examples")
    ...
    def test_coffee_function(self):
        ...
        result = subprocess.call(
            ["python3", "uq_coffee_function.py"], env=os.environ.copy()
        )
        self.assertEqual(result, 0)
    ...
    def test_coffee_class(self):
        ...
        result = subprocess.call(
            ["python3", "uq_coffee_class.py"], env=os.environ.copy()
        )
        self.assertEqual(result, 0)
    ...
    def test_coffee_dependent_function(self):
        ...
        result = subprocess.call(
            ["python3", "uq_coffee_dependent_function.py"], env=os.environ.copy()
        )
        self.assertEqual(result, 0)
    ...
    def test_coffee_dependent_class(self):
        ...
        result = subprocess.call(
            ["python3", "uq_coffee_dependent_class.py"], env=os.environ.copy()
        )
        self.assertEqual(result, 0)
    ...
    def test_hodgkin_huxley(self):
        ...
        result = subprocess.call(
            ["python3", "uq_hodgkin_huxley.py"], env=os.environ.copy()
        )
        self.assertEqual(result, 0)
    ...
    def test_izhikevich_function(self):
        ...
        result = subprocess.call(
            ["python3", "uq_izhikevich_function.py"], env=os.environ.copy()
        )
        self.assertEqual(result, 0)
    ...
    def test_izhikevich_class(self):
        ...
        result = subprocess.call(
            ["python3", "uq_izhikevich_class.py"], env=os.environ.copy()
        )
        self.assertEqual(result, 0)
    ...
    def test_interneuron(self):
        ...
        result = subprocess.call(
            ["python3", "uq_interneuron.py"], env=os.environ.copy()
        )
        self.assertEqual(result, 0)
    ...
    def test_valderrama(self):
        ...
        result = subprocess.call(
            ["python3", "uq_valderrama.py"], env=os.environ.copy()
        )
        self.assertEqual(result, 0)
