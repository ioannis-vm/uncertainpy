...
class TestParameter(unittest.TestCase):
    ...
    def test_set_parameters_file(self):
        ...
        shutil.copy(
            os.path.join(self.test_data_dir, self.parameter_filename), parameter_file
        )
...
class TestParameters(unittest.TestCase):
    ...
    def test_init_dict(self):
        parameters = {"gbar_Na": cp.Uniform(110, 130), "gbar_K": 36, "gbar_L": 0.3}
    ...
    def test_set_distribution(self):
        ...
        self.assertIsInstance(
            self.parameters["gbar_Na"].distribution, cp.Distribution
        )
    ...
    def set_all_distributions(self):
        ...
        self.assertIsInstance(
            self.parameters["gbar_K"].distribution, cp.Distribution
        )
        self.assertIsInstance(
            self.parameters["gbar_L"].distribution, cp.Distribution
        )
    ...
    def test_set_parameters_file(self):
        ...
        compare_file = os.path.join(
            self.test_data_dir, "example_hoc_control_parameters.hoc"
        )
